...
export default function WorkIcarryGo() {
  ...
  return (
    <div>
      <HeroText
        textLines={[
          " Making Travel Search",
          { mobileBreak: true },
          " and Booking Feel ",
          { desktopBreak: true },
          "Effortless for iCarrygo",
        ]}
      />
      ...
      <NextCaseStudy
        to={"/"}
        title="AI Driven SAAS Travel Booking Engine for Intraverse"
        imageSrc="/workcaseIcarrygo.png"
      />
    </div>
  );
}
